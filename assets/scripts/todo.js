  ...
  container.innerHTML = `
        ...
        <div class="todo__form">
            ...
            <div class="todo__input-container">
                <input type="text" id="todo_header" class="todo__input-header" placeholder="Заголовок для задачи" autofocus tabindex="1" />
...
function renderTasks() {
    ...
    tasksBlock.innerHTML = todos.map((todo, index) => `
